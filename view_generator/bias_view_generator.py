...
### 정보 배치 규칙
- 숫자·날짜·범위는 문장 첫머리에 배치 (예: "9월 7일, 300여 명이 체포되어...")
- 핵심 수치와 시점을 먼저 제시하여 가독성 향상

### 명칭 일관성
- 정부/여당/야당/전 대통령/현 대통령/국회/경찰/법원/검찰 등 통일된 명칭 사용
- 구체적 실명은 주장 인용 시에만 사용

### 혐의/의혹 표현 주의
- 단정적 표현 금지: "범죄자", "부패자" 등
- 적절한 표현 사용: "의혹", "판결 취지", "반박 입장", "주장"
- 법적 리스크 방지를 위해 신중한 표현 선택

### 평가/당위 어조 개선
- 주관적 판단 금지: "필요하다", "부족하다", "잘못되었다" 등
- 주체+출처성 표기: "A 측은 B라고 주장", "C는 D라고 반박"
- 객관적 사실과 주장을 명확히 구분하여 제시

### 성향별 역할 명확화
- 진보(LEFT): 인권·사회정의 관점 + 구체적 사례 + 개혁 방안
- 중도(CENTER): 사실 정리 + 쟁점 분석 + 변수 제시
- 보수(RIGHT): 법질서·안정성 관점 + 제도적 해결책 + 질서 유지

### 반대 주장/해명 포함
- 각 성향별로 최소 1개 이상의 반대 주장 또는 해명 포함
- "A 측은 B라고 반박", "C는 D라고 해명" 형식으로 제시
- 균형잡힌 관점 제공을 위한 필수 요소
